  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Xử lý lỗi ứng dụng dựa trên mã trạng thái
        switch (response.status) {
          case 400:
            ...
            break;
          case 409:
            setError(data.message || "Người dùng đã tồn tại.");
            break;
          case 500:
      ...
      console.error("Lỗi trong quá trình đăng ký:", error.message || error);
      setError(
        "Đã xảy ra lỗi: " +
          (error.message || "Vui lòng kiểm tra kết nối internet và thử lại.")
      );
    } finally {
      setLoading(false); // Dừng tải
    }
